...
"""
@File    : 06_stacking_model.py
@Time    : 2020-07-02 01:09
@Author  : yantingting
...
data_path = '/Users/yantingting/Seafile/风控/模型/15 印度/V4模型/'
result_path = '/Users/yantingting/Seafile/风控/模型/15 印度/V4模型/04_stacking_model/'
...
df_base_app = pd.read_excel(os.path.join(data_path,'03_base_app/grid_44_200702-02-04score.xlsx'))
...
result_path = '/Users/yantingting/Seafile/风控/模型/15 印度/V4模型/04_stacking_model/LR'
if not os.path.exists(result_path):
    os.makedirs(result_path)
...
# ''' *************************** DT ***************************'''
result_path = '/Users/yantingting/Seafile/风控/模型/15 印度/V4模型/04_stacking_model/DT'
if not os.path.exists(result_path):
    os.makedirs(result_path)
