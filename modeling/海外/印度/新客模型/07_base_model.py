...
"""
@File    : 07_base_model.py
@Time    : 2020-07-02 17:43
@Author  : yantingting
...
result_path = '/Users/yantingting/Seafile/风控/模型/15 印度/V4模型/05_base'
...
useless_vars = var_dict.loc[var_dict['数据源'] == 'app','指标英文'].tolist()


# """EDA"""
# 删除异常值比例较高的变量
X = x_with_y[x_col]
eda_result = ss.eda(X = X, var_dict=var_dict, useless_vars =useless_vars,exempt_vars = [], uniqvalue_cutoff=0.97)
